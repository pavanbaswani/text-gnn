...
def load_data(dataset_str):
    ...
    for i in range(len(names)):
        with open("/home2/prateekj/GNN-for-text-classification/data/ind.{}.{}".format(dataset_str, names[i]), 'rb') as f:
    ...
    test_idx_reorder = parse_index_file(
        "/home2/prateekj/GNN-for-text-classification/data/ind.{}.test.index".format(dataset_str))
...
def load_corpus(dataset_str):
    ...
    train_idx_orig = parse_index_file(
        "/home2/prateekj/GNN-for-text-classification/data/{}.train.index".format(dataset_str))
